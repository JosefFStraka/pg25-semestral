...
public:
    ...
    void draw(Camera camera) {
        ...
        axisXLine.draw(&resources);
        axisXModel.draw(&resources);
        shader_->setUniform("ucolor", glm::vec4(0.f, 255.f, 0.f, 1.f));
        axisYLine.draw(&resources);
        axisYModel.draw(&resources);
        shader_->setUniform("ucolor", glm::vec4(0.f, 0.f, 255.f, 1.f));
        axisZLine.draw(&resources);
        axisZModel.draw(&resources);

        shader_->setUniform("ucolor", glm::vec4(255.f, 255.f, 255.f, 1.f));
        centerModel.draw(&resources);
