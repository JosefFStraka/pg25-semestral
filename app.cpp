...
void App::init_assets(void) {
  ...
  assets.addProgrammatic("debug_shader",
                         std::make_unique<ShaderProgram>(
                             "../engine/assets/shaders/tex.vert",
                             "../engine/assets/shaders/tex.frag", false));
  assets.addProgrammatic("color_shader",
                         std::make_unique<ShaderProgram>(
                             "../engine/assets/shaders/color.vert",
                             "../engine/assets/shaders/color.frag", false));

  auto argus1Handle = createSimpleModel(
      assets, "argus1_model", assets.getHandle<Mesh>("argus1"),
      assets.getHandle<Texture>("argus1"),
  ...
  auto planeHandle =
      createSimpleModel(assets, "plane_model", assets.getHandle<Mesh>("plane"),
                        assets.getHandle<Texture>("default"),
                        assets.getHandle<ShaderProgram>("phong"));
  {
  ...
  std::string base_path =
      "../resources/textures/skyboxes/vylety_20260403_cubemap/";
  ...
  auto skybox =
      std::make_shared<Skybox>(assets.getHandle<Mesh>("skybox_triangle"), cm,
                               assets.getHandle<ShaderProgram>("skybox"));
